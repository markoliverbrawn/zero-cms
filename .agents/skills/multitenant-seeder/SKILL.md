...
- **Other modules' class seeders**: a module may ship `src/Modules/<Module>/Seeders/<Name>Seeder.php`, which can `require` its own sibling data files that aren't part of the dataset-discovery priority map at all. No module ships one at present.
