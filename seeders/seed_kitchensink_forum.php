<?php
// seeders/seed_kitchensink_forum.php
...
echo "====================================================================\n";
echo "ZERO CMS: DYNAMIC FORUM SEEDER FOR KITCHEN SINK SHOWROOM\n";
echo "====================================================================\n";
...
if (empty($threads)) {
    echo "❌ Error: No threads found for Kitchen Sink site. Seed threads first!\n";
    exit(1);
}

echo "--> Found " . count($threads) . " active forum threads.\n";
...
// 4. Retrieve available user IDs from the kitchensink site
...
// 6. Generate 100 posts (replies) distributed across the 4 threads
$postsToCreate = 100;
$postsCreated = 0;
...
// First, query the 7 existing static/json-seeded posts and populate our thread-to-post mapping
