        ...
        <article class="post-row" style="display: flex; gap: 2rem; margin-bottom: 2.5rem; border-bottom: 1px solid var(--border-color); padding-bottom: 2rem; align-items: flex-start;">
          ...
          <div style="flex-grow: 1;">
            <h3 style="margin-top: 0; margin-bottom: 0.5rem; font-size: 1.5rem;">
              <a href="/post/<?php echo htmlspecialchars($post->slug, ENT_QUOTES, 'UTF-8'); ?>" style="color: var(--neon-cyan); text-decoration: none;">
            ...
            <div class="post-summary" style="color: var(--text-color); margin-bottom: 1.25rem; font-size: 1.05rem; line-height: 1.6;">
              <?php echo htmlspecialchars($post->summary ?? '', ENT_QUOTES, 'UTF-8'); ?>
            </div>
            <a href="/post/<?php echo htmlspecialchars($post->slug, ENT_QUOTES, 'UTF-8'); ?>" class="read-more-btn" style="font-weight: 700; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.05em; color: var(--neon-pink); text-decoration: none;">
