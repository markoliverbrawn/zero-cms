...
<div style="max-width: 550px; margin: 40px auto; padding: 40px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; font-family: sans-serif; color: #0f172a;">
    ...
    <p style="font-size: 1rem; line-height: 1.6;">A request has been received to recover the password associated with your account on <strong><?= htmlspecialchars($siteName) ?></strong>.</p>
    <p style="font-size: 1rem; line-height: 1.6; margin-bottom: 30px;">To reset your password, please click the secure link below. This link is only valid for the next 1 hour:</p>
    <div style="text-align: center; margin-bottom: 35px;">
        <a href="<?= htmlspecialchars($link) ?>" style="display: inline-block; padding: 12px 30px; background-color: #d4af37; color: #000; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em;">Reset My Password</a>
    </div>
