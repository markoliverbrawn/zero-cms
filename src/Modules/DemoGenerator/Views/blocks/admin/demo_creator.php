...
<div class="field-group">
    <label>Demo Form Title / Header</label>
    <input type="text" class="block-title-input" value="<?php echo Str::escape($blockTitle); ?>" placeholder="Spin Up a Demo Sandbox Instance">
</div>
