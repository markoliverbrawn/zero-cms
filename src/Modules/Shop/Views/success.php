<?php
// src/Modules/Shop/Views/success.php
    ...
    <div class="receipt-details-box">
        ...
        <div class="receipt-rows">
            <div class="receipt-row">
                ...
                <span class="receipt-val mono-accent"><?php echo Str::escape($order->id); ?></span>
            </div>
            <div class="receipt-row">
        ...
        <h3 class="receipt-section-title receipt-section-title-sm">Secured Cargo</h3>
