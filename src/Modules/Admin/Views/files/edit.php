          ...
          <?php if (str_starts_with($mimeValue, 'image/')): ?>
            <div class="checkered-background">
              <div class="focal-container" id="focal-container">
                <img src="<?php echo Str::escape((new Media($file))->getVariantUrl(1000)); ?>" alt="<?php echo Str::escape($titleValue ?: $filenameValue); ?>" class="preview-media-image" id="preview-image">
