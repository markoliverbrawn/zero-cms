...
<div class="listrecords files">
  ...
  <?php else: ?>
    ...
    <?php if (!empty($currentFolder)): ?>
      ...
      ?>
      <li class="file-card folder-card go-up-card" style="cursor: pointer;" onclick="window.location.href='?folder=<?php echo htmlspecialchars($parentFolder, ENT_QUOTES, 'UTF-8'); ?>'" data-fid="parent">
